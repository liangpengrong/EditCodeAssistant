...
namespace ProgramTopMenu
{
    public partial class TopMenuContainer : UserControl, MenuItemAopInter
    {
        ...
        private void initTopMenuConfig() {
            topMenuStrip.Name = DefaultNameCof.topMenu;
        ...
        private void MenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //获取当前获得焦点的文本框
                TextBox t = TextBoxCache.FocusTextBox[DefaultNameCof.rootForm];
        ...
        public static MenuStrip getTopMenuStrip() { 
            Control con = ControlCache.getSingletonCache(DefaultNameCof.topMenu);
            if(con == null) {
