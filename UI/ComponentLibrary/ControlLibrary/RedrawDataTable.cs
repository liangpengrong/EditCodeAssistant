...
namespace UI.ComponentLibrary.ControlLibrary {
    public class RedrawDataTable : DataGridView {
        public RedrawDataTable() { 
            setThisStyles();
            ControlsUtilsMet.asynchronousMet(this, 1, delegate{ 
        ...
        private void setDataTableStyle() {    
            Name = DateTime.Now.Ticks.ToString()+"_DataGridView";
